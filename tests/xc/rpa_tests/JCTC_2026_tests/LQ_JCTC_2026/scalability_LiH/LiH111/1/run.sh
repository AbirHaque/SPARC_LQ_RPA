...
#SBATCH -N1 --ntasks-per-node=1                # Number of nodes and cores per node re>
#SBATCH --mem-per-cpu=16G                        # Memory per core
#SBATCH --time=01:00:00                                    # Duration of the job (Ex: 1>
#SBATCH -qinferno                               # QOS Name
#SBATCH -o7_27_2026_%j.out                         # Combined output and error messages>
