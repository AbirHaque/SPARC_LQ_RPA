...
#SBATCH -N32 --ntasks-per-node=16                # Number of nodes and cores per node required
#SBATCH --mem-per-cpu=2G                        # Memory per core
#SBATCH --time=10:00:00                                    # Duration of the job (Ex: 15 mins)
