...
#SBATCH -N256 --ntasks-per-node=16                # Number of nodes and cores per node required
#SBATCH --mem-per-cpu=1G                        # Memory per core
#SBATCH --time=1:00:00                                    # Duration of the job (Ex: 15 mins)
#SBATCH -qinferno                              # QOS Name
#SBATCH -o6_20_2026_%j.out                         # Combined output and error messages file
...
srun -n 4096 ./../../../../../../../../lib/sparc -name LiH
