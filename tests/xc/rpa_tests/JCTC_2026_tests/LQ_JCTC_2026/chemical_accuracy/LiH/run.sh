...
#SBATCH -N64 --ntasks-per-node=8                # Number of nodes and cores per node required
#SBATCH --mem-per-cpu=6G                        # Memory per core
#SBATCH --time=01:00:00                                    # Duration of the job (Ex: 15 mins)
#SBATCH -qinferno                               # QOS Name
#SBATCH -o6_14_2026_%j.out                         # Combined output and error messages file
